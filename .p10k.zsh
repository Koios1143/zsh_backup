# Generated by Powerlevel10k configuration wizard on 2021-09-03 at 20:46 CST.
...
# flat tails, 2 lines, solid, full frame, light-ornaments, sparse, concise,
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=228
  ...
  ###########[ timewarrior: timewarrior tracking status (https://timewarrior.net/) ]############
  # Timewarrior color.
  typeset -g POWERLEVEL9K_TIMEWARRIOR_FOREGROUND=245
  typeset -g POWERLEVEL9K_TIMEWARRIOR_BACKGROUND=214
  ...
  typeset -g POWERLEVEL9K_BATTERY_DISCONNECTED_FOREGROUND=190
  ...
  typeset -g POWERLEVEL9K_TIME_BACKGROUND=157
